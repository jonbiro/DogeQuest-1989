...
export function traversalDescription(run){
  ...
  return '3D running trail. Drag left or right to change one lane; keep dragging to cross another lane without lifting. A clear swipe can switch between steering and jump/slide without lifting. On touch screens, tap a left or right edge to steer or the center to jump. Swipe up to jump, down to slide. Buttons and arrow keys also work. Escape pauses.';
}
