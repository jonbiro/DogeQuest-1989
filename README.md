...
- Drag left/right to switch among three lanes; keep dragging to cross another lane without lifting, with one lane snapped per thumb segment. On touch screens, tapping a left or right edge is a one-lane fallback and a centre tap jumps. Swipe up to jump logs and down to slide under arches.
