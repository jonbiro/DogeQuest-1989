...
- Drag left/right to switch among three lanes; keep dragging to cross another lane without lifting, with one lane snapped per thumb segment. Swipe up to jump logs and down to slide under arches. A tap on the trail also jumps.
