...
const complete={distance:'1,105 m',turns:2,missedTurns:0,proof:{trusted:48,untrusted:0},issues:[],ziplineCaught:true,ziplineLanded:true,regions:['forest','river','canyon'],hearts:'3 hearts remaining'};
