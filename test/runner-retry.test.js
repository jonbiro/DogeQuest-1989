...
test('results retry repeats the seed with a fresh simulation; camp starts a new trail',()=>{
  ...
  const context={localDailyTarget:false,touchControls:true,tilt:{enableDefault(){}},run:original,state:'ended',graphicsReady:true,sharedSeed:null,sharedVersion:null,sharedTarget:0,
