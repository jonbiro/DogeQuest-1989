...
test('scene instructions match the available traversal actions',()=>{
  ...
  assert.match(traversalDescription({}),/Swipes are optional: drag one lane, then keep your finger down, stop moving briefly, and drag again for another lane move/);
