...
test('scene instructions match the available traversal actions',()=>{
  ...
  assert.match(traversalDescription({}),/drag one lane left or right/);
  assert.match(traversalDescription({}),/Press and hold, drag one lane left or right, pause briefly/);
